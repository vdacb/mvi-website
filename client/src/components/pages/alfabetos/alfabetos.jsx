...
class Alfabetos extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            images: ["/img/alfabetos/cover.JPG", "/img/alfabetos.jpg", "/img/top_photos/prelopormenorA.jpg", "/img/top_photos/DSC_7399.jpg", "/img/top_photos/DSC_7456.jpg", "/img//top_photos/DSC_7402.jpg"],
            dropList: [
