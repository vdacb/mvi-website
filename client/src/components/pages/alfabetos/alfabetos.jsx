    ...
    render() {
        ...
        return(
            <div id="alfabetos-container">
                ...
                <HeadlineImage text={this.state.text.slice(11,14)} openPopup={this.openPopup} />
